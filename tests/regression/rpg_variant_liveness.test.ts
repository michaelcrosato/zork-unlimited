...
function wolfJuneCampaignWitnesses(index: RpgIndex): {
  ...
  const required = [
    ...
    semanticVariantKeyByText(
      ...
      "June returned to Albany under your agreement",
    ),
...
function wolfSeededOpeningWitnesses(index: RpgIndex): VariantWitness {
  ...
  required.push(
    semanticVariantKeyByText(
      ...
      "RELEASE loose drive hurdle to redirect the yearling wolf alive",
    ),
...
function wolfCampaignImportWitnesses(index: RpgIndex): {
  ...
  const required = [
    semanticVariantKeyByText(
      ...
      "DC 10 instead of 12). Rowan's full-duty annex and Reese's Works marks",
    ),
    semanticVariantKeyByText(
      index,
      "object",
      ...
      "DC 12 instead of 14). Rowan's full-duty annex lowers the difficulty",
    ),
    ...
    semanticVariantKeyByText(
      ...
      "Emery's service marks provide the lower difficulty",
    ),
    semanticVariantKeyByText(
      index,
      "object",
      ...
      "Fieldcraft 4 set starting DEF to 4 instead of 3. Rowan's civic docket",
    ),
    semanticVariantKeyByText(
      index,
      "object",
      ...
      "Your dispatch packet provides the additional action described on that packet",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "feed-hauler's crawlboard named in Jamie's certified testimony",
    ),
    "room:fodder_loft#1",
    "room:byre_door#9",
    "room:byre_door#24",
    semanticVariantKeyByText(
      ...
      "Reese's Works packet replaces the fallen paling-rail check",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "Reese's Works packet closes Hayden's frost-jammed door-brace option",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "For Hayden's frost-jammed door-brace option, attempt to BRACE fallen paling-rail during HUNT",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "RUN Emery's drover-route marks for one attempt",
    ),
    ...
    semanticVariantKeyByText(
      ...
      "The yearling wolf is dead. Leave the split fallen paling-rail unbound for Hayden's door-brace",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "After the wolf dies, leave the split fallen paling-rail here for Hayden's frost-jammed door-brace",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "Keeping the split fallen paling-rail unbound preserves Hayden's frost-jammed door-brace",
    ),
    "room:byre_door#26",
    semanticVariantKeyByText(
      index,
      ...
      "Leave it unbound for Hayden's door-brace only while the flank-wolf still stands",
    ),
    "room:byre_door#22",
    "room:byre_door#8",
    "room:byre_door#7",
    semanticVariantKeyByText(
      ...
      "If SPLICE is offered, SPLICE marked split paling-rail without another check",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "LAY downwind feed line WITH Cade's winter-feed sack",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "Jamie's sealed relief protocol is still available",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "braced fallen paling-rail redirected the yearling alive after the failed LAY action",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "Your guarded strike chose LURE's combat route",
    ),
    semanticVariantKeyByText(
      index,
      "room",
      ...
      "TURN braced scent-pen to redirect the yearling wolf alive on the remaining feed",
    ),
    semanticVariantKeyByText(
      index,
      "object",
      ...
      "Your guarded strike closed every nonlethal yearling recovery",
    ),
    semanticVariantKeyByText(
      index,
      "object",
      ...
      "TURN braced scent-pen to redirect the yearling wolf alive after the failed feed action",
    ),
    "room:byre_yard#2",
