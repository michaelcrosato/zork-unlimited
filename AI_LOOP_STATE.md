...
- Counterfactual: untouched and Craf-only states remain pending, a failed prepared appeal reads adjourned, and primary plus recovery successes read discharged; three lifecycle regressions pin full/compact/nonmutation behavior and `36350b77…` → `d8b85620…` lineage.
